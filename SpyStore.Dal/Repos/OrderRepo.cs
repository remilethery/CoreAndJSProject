...
namespace SpyStore.Dal.Repos
{
    ...
    public class OrderRepo : RepoBase<Order>, IOrderRepo
    {
        ...
        public OrderWithDetailsAndProductInfo GetOneWithDetails(int orderId)
        {
            ...
            var orderWithDetailsAndProductInfo =
                OrderWithDetailsAndProductInfo.Create(order, order.CustomerNavigation, orderDetailsWithProductInfoForOrder);
